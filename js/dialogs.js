function showStoryIntro() {
    Swal.fire({
        title: '<span style="font-family:Orbitron,sans-serif;color:#FFD700;font-size:1.35rem">POBEG IZ LABORATORIJA</span>',
        html: `
          <div style="text-align:center;font-family:Share Tech Mono,monospace;color:#ccc;line-height:1.9">
            <p style="font-size:1.15rem;color:#3CB043;margin-bottom:8px">&#128001; Ti si <b style="color:#fff">NIBBLES</b></p>
            <p>Najpametnejša miška v raziskovalnem laboratoriju.</p>
            <p>Znanstveniki so odšli — in avtomatsko zaklepanje se je začelo!</p>
            <hr style="border-color:#3CB04333;margin:12px 0">
            <p style="color:#FFD700">&#9888; Imaš <b style="color:#fff">60 sekund</b> da se prebij skozi labirint in pobegneš skozi izhod!</p>
            <hr style="border-color:#3CB04333;margin:12px 0">
            <p style="color:#FFD700">&#9201; Zberi <b style="color:#fff">žetone ur</b> razpršene po labirintu</p>
            <p style="color:#888;font-size:0.85rem">Vsaka ura ti podari <b style="color:#FFD700">+10 dodatnih sekund</b></p>
            <hr style="border-color:#3CB04333;margin:12px 0">
            <p style="color:#e74c3c;font-size:0.9rem">Če odštevalnik doseže nič &mdash; vrata se za vedno zapečatijo!</p>
          </div>
        `,
        background: '#0d0d18',
        color: '#ccc',
        confirmButtonText: '&#128001; Gremo!',
    ...
    Swal.fire({
        ...
        html: `
          <div style="text-align:left;font-family:Share Tech Mono,monospace;color:#ccc;line-height:1.8">
            ...
            <hr style="border-color:#3CB04333;margin:12px 0">
            <p style="margin-bottom:10px;color:#7ecf82;letter-spacing:1px;text-transform:uppercase;font-size:0.75rem">Ure</p>
            <p>&#9201; Zberi zlate žetone ur za <b style="color:#FFD700">+10 sekund</b></p>
            <p style="font-size:0.85rem;color:#888;margin-top:4px">Imaš samo 60s &mdash; poišči vsako sekundo ki jo lahko!</p>
            <hr style="border-color:#3CB04333;margin:12px 0">
